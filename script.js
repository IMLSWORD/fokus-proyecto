...
const imagenInicar = document.querySelector('#start-pause img')
...
botonIniciarPausar.addEventListener('click', () => {
    if(playSonidoIniciar.paused){
        playSonidoIniciar.play()
        
    } else{
        playSonidoPause.play()
    }
...
const cuentaRegresiva = () => {
    ...
    imagenInicar.setAttribute('src', './imagenes/pause.png')
    mostrarTiempo()
}
...
function reiniciar(){
    ...
    imagenInicar.setAttribute('src', './imagenes/play_arrow.png')
}
